                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="form-example-wrap mg-t-30">
                                            ...
                                            <h2 class="mb-4 text-center">📊 Projects Progress Overview</h2>
                                            </div>
                                                ...
                                                <div class="bar-chart-area">
                                                            ...
                                                            @foreach($projects as $i=>$p)
                                                                <div class="bar-chart-wp">
                                                                        <h3 class="mt-5">📌 {{ $p['name'] }}</h3>
                                                                        <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="bar-chart-wp">
                                                                            <canvas id="chart_timeline_{{ $i }}" height="300" class="mt-4"></canvas>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="bar-chart-wp">
                                                                            <canvas id="chart_tasks_{{ $i }}" height="110" class="mt-4"></canvas>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="bar-chart-wp">
                                                                            <canvas id="chart_project_{{ $i }}" height="110"></canvas>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                            <div class="bar-chart-wp">
                                                                            <canvas id="chart_stacked_{{ $i }}" height="110" class="mt-4"></canvas>
                                                                            </div>
                                                                        </div>                                                                 
                                                                </div>
                                                            @endforeach
