                        ...
                        @if($teams->count() > 0)
                            <div class="skill">
                                ...
                                @foreach($teams as $project)
                                    <a href="{{ route('project.tasks', $project->id) }}" style="text-decoration: none;">

                                        <div class="progress" style="cursor:pointer; margin-bottom: 25px;">

                                            <div class="lead-content">
                                                <p>
                                                    Project Name: {{ $project->project_name }}
                                                    // <span style="color:green">Manager: {{ $project->manger->name }}</span>
                                                    // <span style="color:grey">Count Team Members: {{ $project->count_team }}</span>
                                                </p>
                                            </div>

                                            <div class="progress-bar wow fadeInLeft"
                                                data-progress="{{ $project->projectProgress() }}"
